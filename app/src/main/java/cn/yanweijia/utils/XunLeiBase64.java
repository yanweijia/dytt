...
public class XunLeiBase64 {
    ...
    public static String base64encode(byte[] paramArrayOfByte) {
        ...
        int c1, c2, c3;
        while (i < len) {
            c1 = 0xFF & paramArrayOfByte[i++];
            if (i == len) {
                localStringBuffer.append(a[(c1 >>> 2)]);
                localStringBuffer.append(a[((c1 & 0x3) << 4)]);
                localStringBuffer.append("==");
                continue;
            }
            c2 = 0xFF & paramArrayOfByte[i++];
            if (i == len) {
                localStringBuffer.append(a[(c1 >>> 2)]);
            ...
            localStringBuffer.append(a[(c1 >>> 2)]);
            localStringBuffer.append(a[((c1 & 0x3) << 4 | (c2 & 0xF0) >>> 4)]);
            localStringBuffer.append(a[((c2 & 0xF) << 2 | (c3 & 0xC0) >>> 6)]);
            localStringBuffer.append(a[(c3 & 0x3F)]);
        }
